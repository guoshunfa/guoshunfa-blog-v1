---
date: 2021-10-27 11:13:32
permalink: /pages/50aa3d/
author: 
  name: 熊猫代码
...
| 类型名称     | 关键字  | 占用内存 | 取值范围                                   | 封装类    | 封装类缓存对象        |
| ------------ | ------- | -------- | ------------------------------------------ | --------- | --------------------- |
| 字节型       | byte    | 1 字节   | -128~127                                   | Byte      | -128~127（全部值）    |
| 短整型       | short   | 2 字节   | -32768~32767                               | Short     | -128~127              |
| 整型         | int     | 4 字节   | -2147483648~2147483647                     | Integer   | -128~127（默认为127） |
| 长整型       | long    | 8 字节   | -9223372036854775808L~9223372036854775807L | Long      | -128~127              |
| 单精度浮点型 | float   | 4 字节   | +/-3.4E+38F（6~7 个有效位）                | Float     | 无缓存值              |
| 双精度浮点型 | double  | 8 字节   | +/-1.8E+308 (15 个有效位）                 | Double    | 无缓存值              |
| 字符型       | char    | 2 字节   | ISO 单一字符集                             | Character | 0~127                 |
| 布尔型       | boolean | 1 字节   | true 或 false                              | Boolean   | true,false（全部值）  |
...
![img](https://cdn.jsdelivr.net/gh/guoshunfa/pandacode-files/blog/202111012149962.jpg) 
...
![img](https://cdn.jsdelivr.net/gh/guoshunfa/pandacode-files/blog/202111012201979.png)
...
### 11.4. [java运算符 与（&）、非（~）、或（|）、异或（^）](https://www.cnblogs.com/jpfss/p/11014780.html)
